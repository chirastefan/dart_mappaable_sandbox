...
class StudentClothesMapper extends SubClassMapperBase<StudentClothes> {
  ...
  static StudentClothesMapper ensureInitialized() {
    if (_instance == null) {
      ...
      ClothesMapper.ensureInitialized().addSubMapper(_instance!);
  ...
  @override
  final dynamic discriminatorValue = 'StudentClothes';
  @override
  late final ClassMapperBase superMapper = ClothesMapper.ensureInitialized();
...
extension StudentClothesValueCopy<$R, $Out>
...
abstract class StudentClothesCopyWith<$R, $In extends StudentClothes, $Out>
    implements ClothesCopyWith<$R, $In, $Out> {
  ...
  StudentClothesCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
      Then<$Out2, $R2> t);
}

class _StudentClothesCopyWithImpl<$R, $Out>
  ...
  ListCopyWith<$R, StudentPants,
      ...
      get pants => ListCopyWith(
          $value.pants, (v, t) => v.copyWith.$chain(t), (v) => call(pants: v));
  @override
  ...
  @override
  StudentClothesCopyWith<$R2, StudentClothes, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
