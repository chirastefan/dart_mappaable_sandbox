...
extension ClothesValueCopy<$R, $Out> on ObjectCopyWith<$R, Clothes, $Out> {
  ClothesCopyWith<$R, Clothes, $Out> get $asClothes =>
      $base.as((v, t, t2) => _ClothesCopyWithImpl(v, t, t2));
}

abstract class ClothesCopyWith<$R, $In extends Clothes, $Out>
    implements ClassCopyWith<$R, $In, $Out> {
  ListCopyWith<$R, Pants, PantsCopyWith<$R, Pants, Pants>> get pants;
  $R call({String? shirt, List<Pants>? pants});
  ClothesCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _ClothesCopyWithImpl<$R, $Out>
  ...
  @override
  ClothesCopyWith<$R2, Clothes, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) =>
